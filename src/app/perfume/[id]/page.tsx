...
export default function Page() {
  ...
  if (loading) {
    return <main className="pt-28 md:pt-36 min-h-[70vh] px-4 py-10 text-white">Cargando…</main>;
  }
  if (err || !data) {
    return <main className="pt-28 md:pt-36 min-h-[70vh] px-4 py-10 text-white">No encontrado.</main>;
  }
